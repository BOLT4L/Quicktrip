...
function Add(){
  ...
  const filteredSubAdmins = subAdmins.filter((admin) => {
    ...
    return matchesSearch && admin.user_type === filterRole
  })
   ...
   <div className="sub-admins-page">
    <Sidebar/>
                ...
                <tr key={admin.id}>
                  ...
                  <td>
                    <div className="action-buttons">
                      <button className="btn btn-sm btn-danger" onClick={() => handleDeleteSubAdmin(admin.id)}>
                        De-Active account
                      </button>
                    </div>
                  </td>
      ...
      {showModal && <SubAdminModal onClose={() => setShowModal(false)} onSave={handleAddSubAdmin} />}
      </div>
      <style jsx>{`
      .sub-admins-page{
          display :flex;
