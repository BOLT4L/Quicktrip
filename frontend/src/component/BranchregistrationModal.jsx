// BranchRegistrationModal.jsx
// This component renders a modal dialog for registering a new branch/station.
// It collects branch information (name, address, type, coordinates), validates input, and submits to the backend API.
