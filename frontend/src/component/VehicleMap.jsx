// VehicleMap.jsx
// This component displays a Google Map with markers for each vehicle in the provided vehicles array.
// Each marker shows the vehicle's plate number and coordinates in an info window when clicked.
// The map automatically fits all vehicle markers in view and uses custom styling to hide POIs and transit icons.
